...
import com.example.android.preferences.AudioVisuals.AudioInputReader;
import com.example.android.preferences.AudioVisuals.VisualizerView;
...
public class VisualizerActivity extends AppCompatActivity
    ...
    public void loadSizeFromPreferences(SharedPreferences sharedPreferences){
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            ...
            // Other permissions could go down her
        }
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.pref_show_mid_range_key))){
            mVisualizerView.setShowMid(sharedPreferences.getBoolean
                    (key, getResources().getBoolean(R.bool.pref_show_mid_range_default)));
        }
